...
public:
    ...
    Eigen::Vector3d F_fe_pos_sw_W, R_fe_pos_sw_W;
    Eigen::Vector3d hd_l_pos_cur_W, hd_r_pos_cur_W;
    Eigen::Matrix3d hd_l_rot_cur_W, hd_r_rot_cur_W;
    Eigen::Vector3d fe_fl_pos_des_W, fe_fr_pos_des_W;
    Eigen::Vector3d fe_rl_pos_des_W, fe_rr_pos_des_W;
    Eigen::Matrix3d fe_fl_rot_des_W, fe_fr_rot_des_W;
    Eigen::Matrix3d fe_rl_rot_des_W, fe_rr_rot_des_W;
    Eigen::Vector3d fe_fl_pos_cur_W, fe_fr_pos_cur_W;
    Eigen::Vector3d fe_rl_pos_cur_W, fe_rr_pos_cur_W;
    Eigen::Matrix3d fe_fl_rot_cur_W, fe_fr_rot_cur_W;
    Eigen::Matrix3d fe_rl_rot_cur_W, fe_rr_rot_cur_W;
